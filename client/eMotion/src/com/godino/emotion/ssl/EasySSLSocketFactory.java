package com.godino.emotion.ssl;
...
public class EasySSLSocketFactory implements LayeredSocketFactory {
    ...
    private static SSLContext createEasySSLContext() throws IOException {
        try {
        	...
        	InputStream clientStream = ApplicationController.getInstance().getApplicationContext().getResources().openRawResource(R.raw.keystore);
        	char[] password = "emotion".toCharArray();
	        ...
	        instream = ApplicationController.getInstance().getApplicationContext().getResources().openRawResource(R.raw.truststore);

	        try { 
	            trustStore.load(instream, "emotion".toCharArray());
	        } catch (Exception e) {
	            e.printStackTrace();
	        } finally {
